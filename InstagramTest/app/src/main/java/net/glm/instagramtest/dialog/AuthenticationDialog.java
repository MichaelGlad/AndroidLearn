package net.glm.instagramtest.dialog;
...
import net.glm.instagramtest.R;
import net.glm.instagramtest.listener.AuthenticationListener;
...
public class AuthenticationDialog extends Dialog {
    ...
    private void initializeWebView() {
        web_view = (WebView) findViewById(R.id.wv_instagram_authentication);
